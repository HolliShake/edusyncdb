...
namespace INFRASTRUCTURE.Migrations
{
    ...
    [Migration("20250303074531_AddedMissionVisionAndAgencyFields")]
    partial class AddedMissionVisionAndAgencyFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DOMAIN.Model.CampusRegistrar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CampusRegistrar");
                });

            modelBuilder.Entity("DOMAIN.Model.CampusScheduler", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("SchedulerUserId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("SchedulerUserId")
                        .IsUnique();

                    b.ToTable("CampusScheduler");
                });
            ...
            modelBuilder.Entity("DOMAIN.Model.Mission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("MissionDescText")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DOMAIN.Model.SpecializationChair", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DOMAIN.Model.Vision", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DOMAIN.Model.CampusScheduler", b =>
                {
                    ...
                    b.HasOne("DOMAIN.Model.User", "SchedulerUser")
                        .WithMany()
                        .HasForeignKey("SchedulerUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Campus");

                    b.Navigation("SchedulerUser");
                });
            ...
            modelBuilder.Entity("DOMAIN.Model.Mission", b =>
                {
                    b.HasOne("DOMAIN.Model.Vision", "Vision")
                        .WithMany()
