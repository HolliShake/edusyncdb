...
public class AdmissionApplicantService:GenericService<AdmissionApplicant, GetAdmissionApplicantDto>, IAdmissionApplicantService
{
    ...
    public async Task<object?> ApplyApplication(AdmissionApplicantGroupedDto group)
    {
        ...
        if ((await CreateAsync(admissionApplicant)) == null)
        {
            return null;
        }

        // Create parent details
        var parent = new List<AdmissionApplicantFamilyDetails>
        {
            new AdmissionApplicantFamilyDetails
            {
        ...
        return createResult ? admissionApplicant : null;
    }
}
